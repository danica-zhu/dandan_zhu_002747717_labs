...
public class ManageAccountJPanel extends javax.swing.JPanel {
    ...
    ManageAccountJPanel(JPanel bottomJPanel, AccountDirectory accountDirectory) {
        initComponents();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(126, 126, 126)
                                .addComponent(txtAccountNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(161, 161, 161)
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        ...
        if(selectedRow < 0) {
            ...
            Account account = (Account) tblAccount.getValueAt(selectedRow, 0);
            ViewAccountJpanel panel = new ViewAccountJpanel(bottomJPanel,account);
            bottomJPanel.add("ViewAccountJpanel", panel);
            CardLayout layout = (CardLayout) bottomJPanel.getLayout();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (result == null) {
            ...
            ViewAccountJpanel panel = new ViewAccountJpanel(bottomJPanel, result);
            bottomJPanel.add("ViewAccountJpanel", panel);
            CardLayout layout = (CardLayout) bottomJPanel.getLayout();
            layout.next(bottomJPanel);
        }
