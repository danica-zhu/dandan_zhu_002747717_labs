...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public void test() {
        ...
        supplier1.setSupplyName("walmart");
        Supplier supplier2 = supplierDirectory.addSupplier();
        supplier2.setSupplyName("costco");
        Product p1 = supplier1.getProductCatalog().addProduct();
        p1.setProdName("water");
        p1.setPrice(5.6);
        p1.setAvail(300);
        Product p2 = supplier1.getProductCatalog().addProduct();
        p2.setProdName("bread");
        p2.setPrice(6.8);
        p2.setAvail(200);
        Product p3 = supplier2.getProductCatalog().addProduct();
        p3.setProdName("coffee");
        p3.setPrice(2.8);
        p3.setAvail(600);
        Product p4 = supplier2.getProductCatalog().addProduct();
        p4.setProdName("orange");
        p4.setPrice(9.6);
        p4.setAvail(860);
    }
    /**
    ...
    private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        CustomerWorkAreaJPanel cw = new CustomerWorkAreaJPanel(userProcessContainer, 
                supplierDirectory, masterOrderList);
